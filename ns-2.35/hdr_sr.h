...
class hdr_sr {
private:
	int valid_;		/* is this header actually in the packet?and initialized? */ 
	//int variableQueue_;
	...
	struct info_pacchetto info_pkt;
...
public:
	...
	//inline int& getVariableQueue() { return variableQueue_; }
	...
	inline int& get_rinviato() {return info_pkt.rinviato; }
	inline clock_t& get_start() {return info_pkt.start; }
 	inline clock_t& get_stop() {return info_pkt.stop; }
